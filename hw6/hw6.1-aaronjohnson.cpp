...
/*
    This is program 2 of 4 for this assignment. This program
...
int main(int argc, char *argv[]) {
    ...
    if (semOrder_val == 1 && semOutOfSequence_val == 0) {
        // we execute proces 1 and increment semOrder
        puts("Executing process #1.");
        sem_post(semOrder);
    } else {
